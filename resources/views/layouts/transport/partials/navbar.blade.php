...
<div class="dropdown-divider"></div>     <a class="nav-link text-white" href="{{ url('/find_loads') }}">Find Loads</a>     
      ...
      <!-------------------------------------------------->    
        <!-------------------------------------------------->     
        <li class="nav-item active">
        <a class="nav-link text-white" href="{{ url('/insert_transport') }}" >Transport Insert <span class="sr-only">(current)</span></a>
      </li> 
      @if(!empty( \Auth::user()->TransportProfile ))
      <li class="nav-item active">
        <a class="nav-link text-white" href="{{ url('/special-route') }}">Special Route  <span class="sr-only">(current)</span></a>
      </li> 
      @endif
      <!-------------------------------------------------->     
