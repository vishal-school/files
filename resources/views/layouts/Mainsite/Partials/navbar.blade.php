...
<nav class="navbar navbar-expand-lg  navbar-light bg-navcolor text-white ml-auto">
...
<a class="nav-link dropdown-toggle text-white"  id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-hover="dropdown">          Messages      </a> 
 <div class="dropdown-menu   navbar-light  bg-warning "   aria-labelledby="navbarDropdown">
...
<a class="nav-link dropdown-toggle text-white"  id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-hover="dropdown">         Academics and Athletics      </a> 
 <div class="dropdown-menu   navbar-light  bg-warning "   aria-labelledby="navbarDropdown">
            ...
            <a class="nav-link text-white" href="{{ url('/insert-transport') }}" >Transport Insert</a>   
      <div class="dropdown-divider"></div>     <a class="nav-link text-white" href="{{ url('/insert-business') }}">Business Insert</a>   
      ...
      <li class="nav-item active">
       ...
       <li class="nav-item active">
        <a class="nav-link text-white" href="{{ route('business.login') }}">Business Login <span class="sr-only">(current)</span></a>
      </li> 
       <li class="nav-item active">
